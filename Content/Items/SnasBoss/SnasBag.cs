...
namespace ExtraPets2.Content.Items.SnasBoss {
	public class SnasBag : ModItem {
        ...
        public override string Texture => ExtraPets2.AssetPath + "Textures/Items/SnasBoss/SnasBag";

		public override int BossBagNPC => ModContent.NPCType<SnasUdertal>();
		public override void SetStaticDefaults() {
            DisplayName.SetDefault("tersrue bga");
